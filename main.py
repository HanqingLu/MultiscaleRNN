...
if __name__ == '__main__':
    ...
    train(data_path=["../data/train.tok", "../data/valid.tok"], dict_path="../data/dict.pkl",
          size_list=[512, 512], dict_size=10000, embed_size=128, batch_size=args.batch, maxlen=100,
          learning_rate=args.lr, clip=args.clip, max_epoch=100,
          valid_iter=1000, show_iter=100, init=args.init, reload_=args.reload, saveto='model.pt')
