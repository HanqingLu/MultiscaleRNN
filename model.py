...
class HM_Net(Module):
    def __init__(self, a, size_list, dict_size, embed_size):
        ...
        self.LSTM = nn.LSTM(embed_size, 512, 2, batch_first=True, dropout=0.5)
    ...
    def forward(self, inputs, target, mask):
        ...
        h_e = self.embed_out1(h.view(h.size(0) * h.size(1), h.size(2)))  # batch_size*time_steps, hidden_size
